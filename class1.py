...
class Game:
    ...
    def isCheck(self):
        #shohlarning qayerdaligini aniqlang, o'sha shohlarga qarama-qarshi rangdagi barcha qismlarni tekshiring, so'ngra urilgan bo'lsa, uning figura ekanligini tekshiring.
        king = King
        kingDict = {}
    ...
    foydalanuvchi kiritgan ma'lumotni boshlang'ich va yakuniy nuqtalarni bildiruvchi ikkita kortej ro'yxatiga aylantiradigan tahlil qilish funktsiyasi
    ...
    ma'lumotni qabul qiluvchi, uni tahlil qilish vositasidan o'tkazadigan, harakat to'g'ri yoki yo'qligini so'raydi va agar bo'lsa, bo'lakni siljitadi.
...
class Pawn(Piece):
    def __init__(self,color,name,direction):
        self.name = name
        self.Color = color
        #Albatta, eng kichik bo'lakni kodlash eng qiyin. Yo'nalish 1 yoki -1 bo'lishi kerak, agar piyoda "orqaga" ketayotgan bo'lsa -1 bo'lishi kerak"
